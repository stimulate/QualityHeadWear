    ...
    @yield('content')    
            ...
            <footer>                
                <div class="footer_links">
                    <ul>                        
                        <li><a href="http://dochyper.unitec.ac.nz/yuh46/asp_experiment/qc/public/index.php" target="_self">© Quality Cap™</a></li>
                        <li><a href="/stores" target="_self">stores &amp; stockists</a></li>
                        <li><a asp-area="" asp-controller="Home" asp-action="Contact">contact us</a></li>
                        <li><a href="http://dochyper.unitec.ac.nz/yuh46/asp_experiment/qc/public/index.php" target="_self">gift voucher</a></li>
                        <li><a asp-area="" asp-controller="Home" asp-action="About">customer support</a></li>
                        <li><a href="http://dochyper.unitec.ac.nz/yuh46/asp_experiment/qc/public/index.php" target="_self">delivery &amp; returns</a></li>
                        <li><a asp-area="" asp-controller="Home" asp-action="About">your privacy</a></li>
                        <li><a href="http://dochyper.unitec.ac.nz/yuh46/asp_experiment/qc/public/index.php" target="_self">sitemap</a></li>
                    </ul>                    
                </div>
                <div class="footer_content_bottom">
                    ...
                    <div class="social">
                        ...
                        <a href="http://dochyper.unitec.ac.nz/yuh46/asp_experiment/qc/public/index.php">
                            <i class="fa fa-facebook" aria-hidden="true">&nbsp;</i>
                        </a>
                        <a href="http://dochyper.unitec.ac.nz/yuh46/asp_experiment/qc/public/index.php"><i class="fa fa-instagram" aria-hidden="true">&nbsp;</i></a>
                        <a href="http://dochyper.unitec.ac.nz/yuh46/asp_experiment/qc/public/index.php"><i class="fa fa-twitter" aria-hidden="true">&nbsp;</i></a>
                        <a href="http://dochyper.unitec.ac.nz/yuh46/asp_experiment/qc/public/index.php">
                            <i class="fa fa-google-plus" aria-hidden="true">&nbsp;</i>
                        </a> <a href="http://dochyper.unitec.ac.nz/yuh46/asp_experiment/qc/public/index.php"><i class="fa fa-pinterest-p" aria-hidden="true">&nbsp;</i></a>
                        <a href="http://dochyper.unitec.ac.nz/yuh46/asp_experiment/qc/public/index.php"><i class="fa fa-linkedin" aria-hidden="true">&nbsp;</i></a>
                    </div>
                </div>
            </footer> 
            <!-- Scripts -->
